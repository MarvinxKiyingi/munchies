...
const FoodCard = ({ title, image_url, name, className }: IFoodCard) => {
  return (
    <span
      className={`relative flex w-[160px] h-[80px]l min-h-[80px] bg-white border-0.6 border-stroke rounded overflow-hidden ${className}`}
    >
